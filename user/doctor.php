				...
				<section class="staff-block__header">
					...
					<section class="staff-block__info">
						...
						<div class="staff-block__buttons">
                            <?php if ($user->vk != NULL) { ?>
							<a href=<?php echo $user->vk; // vk link ?> class="staff-block__button staff-block__button--img"><img src="../img/vk.svg" alt=""></a>
                            <?php } if ($user->tg != NULL) { ?>
							<a href="<?php echo $user->tg; // tg link ?>" class="staff-block__button staff-block__button--img"><img src="../img/tg.svg" alt=""></a>
                            <?php } ?>
