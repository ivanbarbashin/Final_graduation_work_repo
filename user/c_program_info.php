		...
		<div class="container">
			...
			<div class="c-program-info__content">
				<ol>
					...
					<li class="c-program-info__content-item">Выберите дни недели для проведения созданных тренировок, укажите длительность программы и дату начала. Вы можете не указывать длительность и завершить программу в любое удобное время.</li>
