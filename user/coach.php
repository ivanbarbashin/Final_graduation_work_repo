	...
	<main class="staff-cover">
		<div class="container">
			...
			<section class="staff-block">
				...
				<section class="staff-block__header">
					...
					<section class="staff-block__info">
						<div class="staff-block__name">
							...
							<a class="staff-block__profile-link" href="profile.php?user=<?php echo $user->get_id(); // link to profile ?>"><img src="../img/profile_black.svg" alt=""></a>
						</div>
						<div class="staff-block__buttons">
                            ...
                            <?php } ?>
							<a href="delete_sportsman.php?user=<?php echo $user->get_id(); // link to delite sportsman ?>" class="button-text staff-block__button staff-block__button--delite"><p>Удалить</p> <img src="../img/delete.svg" alt=""></a>
						</div>
					</section>
				</section>
				...
				<section class="staff-block__item">
					...
					<div class="staff-block__nearest-workout-content">
						...
						<a href="my_program.php?user=<?php echo $user->get_id(); // link to more info about workout ?>" class="staff-block__button-more"><p>Подробнее</p> <img src="../img/more_white.svg" alt=""></a>
					</div>
				</section>
				<div class="staff-block__line"></div>
				<section class="staff-block__item">
				...
				<section class="staff-block__item">
				    ...
				    <?php } else { ?>
                        ...
                        <a class="staff-block__button-more staff-block__button-more--control" href="control_workouts.php?user=<?php echo $user->get_id(); // link to more info ?>"><p>Подробнее</p> <img src="../img/more_white.svg" alt=""></a>
                    <?php } ?>
                </section>
				<div class="staff-block__line"></div>
				<section class="staff-block__item">
			...
			<section class="staff-other__buttons">
				<?php if ($is_selected){ ?>
                    <a href="my_program.php?user=<?php echo $user->get_id(); // program of sportsman ?>" class="button-text staff-other__button"><p>Программа</p> <img src="../img/my_programm.svg" alt=""></a>
                    <a href="progress.php?user=<?php echo $user->get_id(); // progress of sportsman ?>" class="button-text staff-other__button"><p>Прогресс спортсмена</p> <img src="../img/progress.svg" alt=""></a>
                <?php }?>
