...
* генерация статистики по прошедшим тренировкам: количество тренировок за выбранный промежуток времени, процентное соотношение тренировок по группам тренируемых мышц, тенденции по сбросу/набору веса, среднее время тренировки.
